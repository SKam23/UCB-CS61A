...
def make_glookup(class_assignments):
    ...
    0.8913043478260869
    """
    dict = class_assignments
    total_points, current_points= 0.0,0.0
    def helper(assignment, points):
        nonlocal total_points, current_points
        total_points = total_points + dict[assignment]
