...
def is_swap(player_score, opponent_score):
    ...
    player_ones, opponent_ones, opponent_tens, switch = player_score%10, opponent_score%10, (opponent_score//10)%10, False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    previous_roll0, previous_roll1 = 0,0
    while (score0 < goal) and (score1 < goal):
        if who == 0:
            if feral_hogs:
                num_dice= strategy0(score0, score1)
                current_roll = take_turn(num_dice, score1, dice)
                if abs(num_dice - previous_roll0)==2:
                    score0 = score0 + current_roll + 3
                else:
                    score0 = score0 + current_roll
                previous_roll0= current_roll
            else:
            ...
            if feral_hogs:
                ...
                current_roll = take_turn(num_dice, score0, dice)
                if abs(num_dice - previous_roll1)==2:
                    score1 = score1 + current_roll + 3
                else:
                    score1 = score1 + current_roll
...
def max_scoring_num_rolls(dice=six_sided, trials_count=10000):
    ...
    # BEGIN PROBLEM 9
    temp_score = 0
    best_number_of_rolls=1
    temo_roll_avg = make_averaged(roll_dice,trials_count)(i,dice)
    for i in range(1,11):
        if temo_roll_avg > temp_score:
            temp_score = temo_roll_avg
            best_number_of_rolls = i
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if  free_bacon(opponent_score)+score > opponent_score and is_swap(free_bacon(opponent_score)+score,opponent_score):
        return num_rolls
    elif is_swap(free_bacon(opponent_score)+score,opponent_score):
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    temp = 100 - score
    # if opponent_score > 70 and score <20:
    #     return 6
    if free_bacon(opponent_score) >= temp:
        return 0
    # elif score > 94:
    #     return 2
    elif free_bacon(opponent_score)+score > opponent_score and is_swap(free_bacon(opponent_score)+score,opponent_score):
        return 6
    elif is_swap(free_bacon(opponent_score)+score,opponent_score):
        return 0
